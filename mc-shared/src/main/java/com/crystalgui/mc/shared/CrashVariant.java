 ...
 * a stack trace reads {@code com.crystalgui.mc.forge.common.LifecycleCrystalGUI} — and "which variant is
...
public final class CrashVariant {
    ...
    public static final String LABEL = "CrystalGUI variant";
     ...
     * filesystem reports
     * {@code union:/C:/.../mods/crystalgui-1.0.0.jar%23180!/}, where the interesting part is four
