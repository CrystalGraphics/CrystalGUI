...
public class AssetControl extends ValueControl<String> {
    ...
    public static final Name NAME = Name.of("assetcontrol");
     ...
     * exists so a theme can address {@code assetcontrol } by tag. */
    public AssetControl() {
    ...
    public AssetControl(ConfigDescriptor descriptor, @Nullable String defaultValue) {
        super(NAME, descriptor, defaultValue == null ? "" : defaultValue);
        addClass("__asset__");
