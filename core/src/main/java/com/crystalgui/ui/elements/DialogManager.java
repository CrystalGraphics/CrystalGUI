 ...
 * <p>The alternative shape considered was several real {@code UIWindow}s with something arbitrating
...
public final class DialogManager {
    ...
    public Dialog manage(Dialog dialog) {
        ...
        dialogs.add(dialog);
        if (dialog.getParent() != stage) stage.addChild(dialog);
    ...
    public void unmanage(Dialog dialog) {
        ...
        if (dialog.getParent() == stage) stage.removeChild(dialog);
