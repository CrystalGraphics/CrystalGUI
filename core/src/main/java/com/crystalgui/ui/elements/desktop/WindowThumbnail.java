 ...
 *
 * <h3>Aspect is preserved, and the picture is centred in whatever box it is given</h3>
 *
 * <p>A window is rarely the same shape as a preview panel. Fitting rather than stretching is what makes a
 * thumbnail readable as the window it stands for; the letterboxing is the panel's own background, so a
 * theme decides what shows through.</p>
 *
