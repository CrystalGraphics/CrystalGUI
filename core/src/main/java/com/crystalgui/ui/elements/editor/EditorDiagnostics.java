 ...
 * </ul>
 */
final class EditorDiagnostics {

    private final TextEditor editor;

    EditorDiagnostics(TextEditor editor) {
        this.editor = editor;
    }
     ...
     */
    void install(String owner, @Nullable Versioned<List<Diagnostic>> announced) {
     ...
     */
    @Nullable
    TrackedRange trackedRangeFor(@Nullable Diagnostic problem) {
     ...
     */
    boolean goTo(@Nullable Diagnostic target) {
