...
public final class CommandPalette {
    ...
    /**
     * This engine's surface, for a command that needs to reach one.
     *
     * <p>Declared here rather than in {@code UiDataKeys} for the reason {@code MenuBarView.MENU_BAR}
     * is: a {@link DataKey}'s type IS the thing it names, and {@code UiDataKeys.WINDOW} is a
     * {@code DataKey<UIWindow>}. A key naming an engine class cannot be shared between engines.</p>
     */
    public static final DataKey<UIDocument> SURFACE =
            DataKey.create("surface", UIDocument.class);
