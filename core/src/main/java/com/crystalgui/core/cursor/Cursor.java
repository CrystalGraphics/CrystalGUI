 ...
 * cursors at all and can only build custom ones from pixel data ({@link CursorBitmaps} supplies those).
 * So a caller resolves a value and hands it to {@link com.crystalgui.core.cursor.CursorService},
