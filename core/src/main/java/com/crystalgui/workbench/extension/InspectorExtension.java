...
public final class InspectorExtension implements WorkbenchExtension {
    ...
    public Disposable activate(WorkbenchContext workbench) {
        ...
        inspector.emptyState().setHeading("To inspect an object:").setLines(
                "— Select an element on a canvas, as in a .cgui file",
                "— Select a node in a graph, as in a .shadergraph file");
