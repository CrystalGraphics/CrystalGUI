 ...
 *
 * <p><b>Entirely ours.</b> The web has no window manager, so unlike the top layer or {@code resize}
 ...
 */
public class DialogManagerTest extends UiTestBase {
    ...
    private float left(Dialog d) {
        return d.getRuntimeCache().getX() - stage.getRuntimeCache().getX();
    }
    ...
    /**
     * Clicking anywhere in a window activates it — including on a control that consumes the press for
     ...
     * marching a window out of reach. No wrap logic needed in the manager. */
    @Test
    ...
    public void unmanagingRemovesItFromTheStageAndTheSet() {
        ...
        assertNull("and it leaves the tree", c.getParent());
