 ...
 */
public class WorkbenchRegionWeightTest extends UiTestBase {
    ...
    public void setUpRegions() {
        ...
        root.addChild(regions.root());
        window = new UIWindow(Ui.of(root));
        window.init(AXIS, 600);
        settle();
    }
    ...
    private float sidebarWidth() {
        settle();
        return regions.host(DockRegion.SIDEBAR).getRuntimeCache().getWidth();
    }
