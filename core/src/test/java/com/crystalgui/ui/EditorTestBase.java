...
/**
 * The fixture every editor test shares — a window, an input stub, a clipboard and the helpers that read
 * what was drawn.
 *
 ...
 */
public abstract class EditorTestBase extends UiTestBase {
