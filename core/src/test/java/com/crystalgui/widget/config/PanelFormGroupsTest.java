 ...
 *
 * <p>{@link PanelForm#group} hands back a <em>new</em> form scoped to the group's content, and the original
 * keeps writing at the level it was already at. Ignoring the return value is silent: the rows appear exactly
 * where they were going to appear, as SIBLINGS of an empty group — so collapsing it hides nothing and the
 * twisty reads as dead.</p>
 */
public class PanelFormGroupsTest {
    ...
    public void rowsGoIntoTheGroupTheFormHandsBack() {
        ...
        ConfigForm inside = form.group("Computed", true);
