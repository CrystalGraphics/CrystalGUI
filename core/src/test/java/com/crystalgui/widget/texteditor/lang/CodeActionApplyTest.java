 ...
 */
public class CodeActionApplyTest extends UiDocumentTestBase {
    ...
    public void goingToAProblemCentresIt() {
        ...
        float boxHeight = editor.box().height();
        float lineTopOnScreen = 200 * lineHeight - editor.scrollTop();
        float middle = boxHeight / 2f;
        assertTrue("row 200 sits at " + lineTopOnScreen + " in a box of " + boxHeight
                        + " (scrollTop=" + editor.scrollTop() + ", lineHeight=" + lineHeight + ")",
