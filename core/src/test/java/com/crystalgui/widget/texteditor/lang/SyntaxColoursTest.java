 ...
 */
public class SyntaxColoursTest extends UiDocumentTestBase {
    ...
    public void aJavaKeywordIsBothPublishedAndColouredByTheUserAgentSheet() {
        ...
        HighlightStyle style = document.styleEngine().highlightStyle(line, "keyword");
    ...
    public void everyShippedTokenNameHasAColour() {
        ...
        for (String name : new String[]{"keyword", "type", "string", "number", "comment", "function"}) {
            ...
            HighlightStyle style = document.styleEngine().highlightStyle(line, name);
    ...
    public void aGlslFileIsColouredThroughTheRegistry() {
        ...
        assertFalse(document.styleEngine().highlightStyle(line, "keyword").isEmpty());
    }
    ...
    public void keywordsAndCommentsAreDifferentColours() {
        ...
        int keyword = document.styleEngine().highlightStyle(keywordLine, "keyword").color(0);
        int comment = document.styleEngine().highlightStyle(commentLine, "comment").color(0);
