...
```bash
**1.20.x/1.21.x** — a node per (loader, Minecraft version): forge:1.15.2 | forge:1.16.5 | forge:1.17.1 | forge:1.18.2 | forge:1.19.2 | forge:1.19.3 | forge:1.19.4 | forge:1.20.1 | forge:1.20.2 | forge:1.20.4 | forge:1.20.6 | forge:1.21.1 | forge:1.21.3 | forge:1.21.4 | forge:1.21.5 | forge:1.21.6 | forge:1.21.8 | forge:1.21.10 | forge:1.21.11 | neoforge:1.20.2 | neoforge:1.20.3 | neoforge:1.20.4 | neoforge:1.20.6 | neoforge:1.21.1 | neoforge:1.21.3 | neoforge:1.21.4 | neoforge:1.21.5 | neoforge:1.21.6 | neoforge:1.21.8 | neoforge:1.21.10 | neoforge:1.21.11 | fabric:1.15.2 | fabric:1.16.5 | fabric:1.17.1 | fabric:1.18.2 | fabric:1.19.2 | fabric:1.19.3 | fabric:1.19.4 | fabric:1.20.1 | fabric:1.20.2 | fabric:1.20.4 | fabric:1.20.6 | fabric:1.21.1 | fabric:1.21.3 | fabric:1.21.4 | fabric:1.21.5 | fabric:1.21.6 | fabric:1.21.8 | fabric:1.21.10 | fabric:1.21.11 — every release from 1.15 to 1.21.11 on Forge and Fabric (1.15.x and 1.16.x on one node each) and from 1.20.2 on NeoForge, except Forge 1.21 (refused: Forge 51 has no HUD event), Fabric 1.16, 1.16.1 and 1.21.9 (refused: their only Fabric APIs lack a module the hosts use) and the Forge versions never published (1.16, 1.17, 1.20.5, 1.21.2). Below 1.17 the nodes are built by Loom and Unimined rather than ModDevGradle, and Forge 1.15-1.16 instances run Java 8. Below 1.19.3 Minecraft ships no JOML, and those instances take CrystalGraphics' `crystalgraphics-joml` companion (`prismInstanceJoml`). NeoForge 1.21.2, 1.21.6, 1.21.7 and 1.21.9 run their only builds, betas; the NeoForge and Forge 1.21.10 nodes also claim 1.21.9. A node claims the versions it was booted on; its `variant.minecraft` says which.
