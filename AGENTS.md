...
```bash
**1.20.x/1.21.x** — a node per (loader, Minecraft version): forge:1.20.1 | neoforge:1.20.4 | neoforge:1.20.6 | neoforge:1.21.1 | fabric:1.20.1 | fabric:1.20.4 | fabric:1.20.6 | fabric:1.21.1.
