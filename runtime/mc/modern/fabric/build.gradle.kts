...
dependencies {
    ...
    // module bundles :core and :runtime:mc:modern:common below, so there is no library half to add separately
...
// `:runtime:mc:modern:fabric:runClient --dry-run` builds neither `jar` nor `remapJar`. A dev run resolves from
