...
| `--builder-guide` | `var(--error)` | base.css |
...
| `--insertmenu-band-bg` | `var(--surface-base)` | base.css |
| `--insertmenu-bg` | `var(--surface-panel)` | base.css |
| `--insertmenu-border` | `var(--border-strong)` | base.css |
| `--insertmenu-count-fg` | `var(--fg-hint)` | base.css |
| `--insertmenu-divider` | `var(--border-base)` | base.css |
| `--insertmenu-field-bg` | `var(--surface-recessed)` | base.css |
| `--insertmenu-field-border` | `var(--border-field)` | base.css |
| `--insertmenu-field-focus-border` | `var(--accent)` | base.css |
| `--insertmenu-hint-fg` | `var(--fg-hint)` | base.css |
| `--insertmenu-hover-bg` | `var(--hover-bg)` | base.css |
| `--insertmenu-icon-fg` | `var(--fg-secondary)` | base.css |
| `--insertmenu-key-bg` | `var(--surface-raised)` | base.css |
| `--insertmenu-key-border` | `var(--border-strong)` | base.css |
| `--insertmenu-key-fg` | `var(--fg-secondary)` | base.css |
| `--insertmenu-relation-fg` | `var(--fg-secondary)` | base.css |
| `--insertmenu-selected-bg` | `var(--selection-bg)` | base.css |
| `--insertmenu-target-fg` | `var(--fg)` | base.css |
| `--insertmenu-title-fg` | `var(--fg-secondary)` | base.css |
...
| `--kind-glyph-addon` | `#7AC0A0` | crystal-dark.css |
| `--kind-glyph-addon-selected` | `#9EF2CB` | crystal-dark.css |
| `--kind-glyph-collection` | `#B38FD8` | crystal-dark.css |
| `--kind-glyph-collection-selected` | `#E9BAFF` | crystal-dark.css |
| `--kind-glyph-control` | `#75B1ED` | crystal-dark.css |
| `--kind-glyph-control-selected` | `#92E8FF` | crystal-dark.css |
| `--kind-glyph-layout` | `#AEA79C` | crystal-dark.css |
| `--kind-glyph-layout-selected` | `#E2D9CB` | crystal-dark.css |
| `--kind-glyph-overlay` | `#68C4BE` | crystal-dark.css |
...
| `--lab-ghost` | `#7A7A7A` | crystal-dark.css |
| `--lab-ghost-on-light` | `#8C8F94` | crystal-dark.css |
| `--lab-ground-dark` | `#000000` | crystal-dark.css |
| `--lab-ground-light` | `#FFFFFF` | crystal-dark.css |
| `--lab-mark` | `#DFE1E5` | crystal-dark.css |
| `--lab-mark-on-light` | `#1E1F22` | crystal-dark.css |
...
| `--lab-specimen-on-light` | `#00000014` | crystal-dark.css |
...
| `--preview-bg` | `var(--surface-overlay)` | base.css |
...
| `--switcher-bg` | `var(--surface-overlay)` | base.css |
...
| `--taskbar-entry-fg` | `var(--fg)` | base.css |
| `--taskbar-entry-hidden-fg` | `var(--fg)` | base.css |
...
| `--window-icon-tile-4` | `#8B63D9` | crystal-dark.css |
| `--window-icon-tile-5` | `#2FA7B8` | crystal-dark.css |
| `--window-icon-tile-6` | `#D85A7A` | crystal-dark.css |
