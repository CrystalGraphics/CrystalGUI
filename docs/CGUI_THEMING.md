...
| `--accent-soft` | `#2F5F9E` | crystal-dark.css |
| `--activitybar-badge-fg` | `var(--fg-on-accent)` | base.css |
| `--activitybar-bg` | `var(--surface-panel)` | base.css |
| `--activitybar-item-checked-bg` | `var(--selection-inactive-bg)` | base.css |
...
| `--editor-bg` | `#1E1E1E` | dark-plus.css |
...
| `--editorfind-border` | `var(--divider)` | base.css |
...
| `--findbar-action-disabled-bg` | `var(--surface-panel)` | base.css |
...
| `--graph-canvas` | `var(--surface-base)` | base.css |
...
| `--menu-separator` | `var(--divider)` | base.css |
...
| `--notifications-bg` | `var(--surface-panel)` | base.css |
...
| `--preview-surface-bg` | `var(--surface-base)` | base.css |
| `--problems-bg` | `var(--surface-panel)` | base.css |
...
| `--problems-tab-active-count-fg` | `var(--fg-on-accent)` | base.css |
| `--problems-tab-active-fg` | `var(--fg-on-accent)` | base.css |
| `--problems-tab-count-fg` | `var(--fg-hint)` | base.css |
| `--problems-tab-fg` | `var(--fg-secondary)` | base.css |
| `--problems-tab-hover-bg` | `var(--hover-bg)` | base.css |
...
| `--scrollbar-corner` | `var(--surface-base)` | base.css |
| `--scrollbar-tail` | `var(--surface-raised)` | base.css |
| `--scrollbar-tail-hover` | `var(--border-base)` | base.css |
| `--scrollbar-thumb` | `var(--border-base)` | base.css |
| `--scrollbar-thumb-hover` | `var(--border-strong)` | base.css |
| `--scrollbar-thumb-pressed` | `var(--fg-secondary)` | base.css |
| `--scrollbar-track` | `var(--surface-base)` | base.css |
...
| `--surface-raised` | `#3A3A3A` | crystal-dark.css |
| `--surface-recessed` | `#1E1E1E` | crystal-dark.css |
...
| `--tab-active-bg` | `var(--surface-panel)` | base.css |
| `--tab-active-fg` | `var(--fg)` | base.css |
| `--tab-bg` | `var(--surface-raised)` | base.css |
...
| `--tab-pane-bg` | `var(--surface-panel)` | base.css |
| `--tab-strip-bg` | `var(--surface-base)` | base.css |
