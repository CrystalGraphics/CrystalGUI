...
val modernNodes: Map<String, List<String>> =
    if (embedded) linkedMapOf("common" to listOf("1.20.1"), "forge" to listOf("1.20.1"))
        ...
        "common" to listOf("1.20.1", "1.20.2", "1.20.3", "1.20.4", "1.20.6", "1.21.1"),
        "forge" to listOf("1.20.1", "1.20.2", "1.20.4", "1.20.6", "1.21.1"),
        "neoforge" to listOf("1.20.2", "1.20.3", "1.20.4", "1.20.6", "1.21.1"),
        "fabric" to listOf("1.20.1", "1.20.2", "1.20.4", "1.20.6", "1.21.1"),
    )
