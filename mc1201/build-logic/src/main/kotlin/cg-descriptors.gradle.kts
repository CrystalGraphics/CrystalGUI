...
val generateMergedDescriptors = tasks.register("generateMergedDescriptors") {
    ...
    doLast {
        ...
        logger.lifecycle("[cgui] merged descriptors for {} variants -> {}", descriptor.variants.size, root)
    }
}
...
val checkDescriptorsAgree = tasks.register("checkDescriptorsAgree") {
    ...
    doLast {
        ...
        logger.lifecycle("[cgui] four shipped descriptors agree with the declaration")
    }
}
