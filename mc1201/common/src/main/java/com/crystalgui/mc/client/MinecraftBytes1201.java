 ...
 */
public final class MinecraftBytes1201 {

    /** The one instance — stateless, and the loader it reads is fixed. */
    public static final ReadableView.ByteSource SOURCE = MinecraftBytes1201::bytesOf;

    private MinecraftBytes1201() {
    }
    ...
    private static byte[] bytesOf(String internalName) throws IOException {
        ...
        ClassLoader loader = MinecraftBytes1201.class.getClassLoader();
