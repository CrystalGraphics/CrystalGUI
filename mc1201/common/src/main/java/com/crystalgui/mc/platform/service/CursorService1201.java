 ...
 *
 * <p>The LWJGL3 counterpart of {@link CursorService1710}, and mostly the easier of the two: GLFW ships
 ...
 * <p>{@link CursorService1710} has to mirror every bitmap vertically and measure the hotspot from the
 ...
 */
public final class CursorService1201 implements CursorService {
    ...
    /** GLFW's own cursor if it knows this picture, our artwork if not. @see CursorService1201 */
